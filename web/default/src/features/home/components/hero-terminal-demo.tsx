    ...
    <div className={cn('mx-auto w-full', props.className)}>
      ...
      >
          ...
          {API_DEMOS.map((item, index) => {
            ...
            return (
              <button
                ...
                className={cn(
                  'relative -mb-px flex items-center gap-1.5 border-b-2 px-2 py-1.5 text-[10px] font-medium tracking-wide transition-colors sm:px-2.5 sm:text-[11px]',
                  isActive
        ...
        >
          ...
          <code
            className={cn(
              'text-foreground/75 truncate font-mono text-[11px] transition-opacity duration-200',
        ...
        <div className='grid h-[240px] grid-rows-[130px_minmax(0,1fr)] font-mono text-[10px] leading-[1.4]'>
          {/* Request */}
        ...
        >
          <div className='text-foreground/40 flex items-center gap-2 text-[9px] tabular-nums'>
          ...
          <span className='text-foreground/30 font-mono text-[8px] tracking-wider uppercase'>
            stream · sse
          </span>
        </div>
      </div>
...
function SectionLabel(props: { children: ReactNode }) {
  return (
    <span className='text-foreground/30 font-sans text-[9px] font-semibold tracking-[0.18em] uppercase'>
      {props.children}
    </span>
  )
}
