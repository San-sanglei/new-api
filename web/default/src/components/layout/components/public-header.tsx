...
export interface PublicHeaderProps {
  ...
  className?: string
  /**
   * When true, use the provided `navLinks` prop instead of dynamic links
   * resolved from backend HeaderNavModules configuration.
   */
  overrideDynamicNav?: boolean
}
...
export function PublicHeader(props: PublicHeaderProps) {
  ...
  const links = overrideDynamicNav
    ? navLinks
