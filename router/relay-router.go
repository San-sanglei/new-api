...
func SetRelayRouter(router *gin.Engine) {
	...
	playgroundRouter.Use(middleware.UserAuth(), middleware.Distribute(), middleware.T0ModelRateLimit())
	{
	...
	relayV1Router.Use(middleware.ModelRequestRateLimit())
	{
		...
		wsRouter.Use(middleware.Distribute(), middleware.T0ModelRateLimit())
	...
	}
	{
		...
		httpRouter.Use(middleware.Distribute(), middleware.T0ModelRateLimit())
	...
	relayGeminiRouter.Use(middleware.Distribute(), middleware.T0ModelRateLimit())
	{
