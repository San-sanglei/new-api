...
func getOidcUserInfoByCode(code string) (*OidcUser, error) {
	...
	req, err := http.NewRequestWithContext(context.Background(), "POST", system_setting.GetOIDCSettings().TokenEndpoint, strings.NewReader(formData))
	if err != nil {
		return nil, err
	}
	...
	// P1-2 修复：使用 NewRequestWithContext
	req, err = http.NewRequestWithContext(context.Background(), "GET", system_setting.GetOIDCSettings().UserInfoEndpoint, nil)
	if err != nil {
		return nil, err
	}
