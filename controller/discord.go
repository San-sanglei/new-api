...
func getDiscordUserInfoByCode(code string) (*DiscordUser, error) {
	...
	req, err := http.NewRequestWithContext(context.Background(), "POST", "https://discord.com/api/v10/oauth2/token", strings.NewReader(formData))
	if err != nil {
		return nil, err
	}
	...
	// P1-2 修复：使用 NewRequestWithContext
	req, err = http.NewRequestWithContext(context.Background(), "GET", "https://discord.com/api/v10/users/@me", nil)
	if err != nil {
		return nil, err
	}
