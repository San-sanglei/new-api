...
func GetStatus(c *gin.Context) {
	...
	data := gin.H{
		...
		"linuxdo_oauth":               common.GetLinuxDOOAuthEnabled(),
		"linuxdo_client_id":           common.LinuxDOClientId,
		"linuxdo_minimum_trust_level": common.LinuxDOMinimumTrustLevel,
		"telegram_oauth":              common.GetTelegramOAuthEnabled(),
		...
		"register_enabled":              common.GetRegisterEnabled(),
		"password_login_enabled":        common.GetPasswordLoginEnabled(),
		"password_register_enabled":     common.GetPasswordRegisterEnabled(),
...
func SendEmailVerification(c *gin.Context) {
	...
	taken, err := model.IsEmailAlreadyTaken(email)
	if err != nil {
		c.JSON(http.StatusOK, gin.H{
			"success": false,
			"message": err.Error(),
